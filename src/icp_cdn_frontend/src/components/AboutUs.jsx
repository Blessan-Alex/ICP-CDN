  ...
  const teamMembers = [
    {
      ...
      linkedin: "https://linkedin.com/in/sakshi-khatri",
      github: "https://github.com/sakshi-khatri",
    ...
    },
    {
      ...
      linkedin: "https://linkedin.com/in/mani-verma",
      github: "https://github.com/mani-verma",
    ...
    },
    {
      ...
      linkedin: "https://linkedin.com/in/blessan-alex",
      github: "https://github.com/blessan-alex",
      email: "blessan@example.com"
    }
  ];
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          {teamMembers.map((member, index) => (
            <div key={index} className="bg-neutral-900/50 backdrop-blur-sm rounded-2xl p-8 border border-neutral-800 hover:border-orange-500/50 transition-all duration-300 hover:shadow-xl hover:shadow-orange-500/10 hover:-translate-y-1">
              {/* Avatar Placeholder */}
              ...
              <div className="flex justify-center space-x-4">
                <a 
                  ...
                  className="p-2 bg-neutral-800 rounded-lg hover:bg-orange-500/20 hover:text-orange-500 transition-colors duration-200"
                >
                  <Linkedin size={20} />
                </a>
                <a 
